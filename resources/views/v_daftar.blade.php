...
<img id="background" src="{{ URL::asset('image/background2.jpg') }}">
	<div id="atas-home">
		<div class="ui grid">
	  		...
	  		<div class="five wide column" style="margin-top: 50px;margin-left: 475px;margin-right: 450px;">
	  			<div class="ui container" style="background-color: #696969;border-radius: 20px;">
